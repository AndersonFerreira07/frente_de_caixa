...
export type Table2Props = {
  ...
  openNota: (id: number) => void;
};

const Table2: FC<Table2Props> = ({ rows, removeItens, openNota }) => {
  ...
  function formataDados(list: Row[]) {
    ...
    for (let i = 0; i < list.length; i += 1) {
      listFormated.push({
        ...
        valorDinheiro: formatMoeda(list[i].valorDinheiro),
      });
    }
    return listFormated;
  }
                ...
                (row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="right">{row.valorDinheiro}</TableCell>
                      <TableCell align="right">
                        <Button
                          variant="contained"
                          color="secondary"
                          onClick={(e) => openNota(parseInt(row.uidd, 10))}
                        >
                          Imprimir
                        </Button>
                      </TableCell>
